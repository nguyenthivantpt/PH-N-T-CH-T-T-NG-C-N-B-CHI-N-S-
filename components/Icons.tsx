...
export const InitialStateIcon: React.FC = () => (
...
export const AnalysisIcon: React.FC = () => (
     <div className="bg-sky-100 dark:bg-sky-900/50 p-3 rounded-full">
        <svg className="h-6 w-6 text-sky-600 dark:text-sky-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
export const WarningIcon: React.FC = () => (
    <div className="bg-yellow-100 dark:bg-yellow-800/40 p-3 rounded-full">
